...
class box_layout_demo:
    ...
    def __init__(self, **kwargs):
        """
                Construct main app
                """
        super(box_layout_demo, self).__init__(**kwargs)
        # basic data example - dictionary of names
        self.box_layout_demo = {"Clear, Guido, Greet, Hello guido"}
    ...
    def build(self):
        ...
        """
        self.title = "box_layout_demo - Popup & Buttons"
